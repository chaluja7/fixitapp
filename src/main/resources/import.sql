...
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('Stará esta s18', 'Porouchaná sušučka', '', '2014-10-22 12:41:04.777', 50.081382, 14.427800, 'IN_PROGRESS', 1);
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('Na poříčí hošánci', 'vyfocené kuřátko', '', '2014-10-22 13:41:04.777', 50.081272, 14.428791, 'IN_PROGRESS', 1);
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('U suchdola 5', 'Nějaká bezejmenná škoda', '', '2014-10-22 14:41:04.777', 50.081492, 14.426810, 'IN_PROGRESS', 1);
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('Borovského ulice 154', 'Hokejisti zničili stadion', '', '2014-10-22 15:41:04.777', 50.081500, 14.429820, 'IN_PROGRESS', 1);
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('Adresa na kraji města', 'Ptačí výkaly na ulici', '', '2014-10-22 16:41:04.777', 50.081610, 14.430830, 'IN_PROGRESS', 1);
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('Bitevního pole 16', 'Černá skládka v centru města!!!', '', '2014-10-22 17:41:04.777', 50.081720, 14.431840, 'IN_PROGRESS', 1);
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('ADresa na konci svězta', 'Nejaký trouba vyndal kostky z chodníku', '', '2014-10-22 18:41:04.777', 50.081830, 14.432850, 'NEW', 1);
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('Příčná ulice 19', 'Jen si z vás dělám srandu saláti', '', '2014-10-22 19:41:04.777', 50.081940, 14.433860, 'NEW', 1);
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('U Olivandera 1', 'Rozbitá výloha souukromého obchodu', '', '2014-10-22 20:41:04.777', 50.082000, 14.434870, 'NEW', 1);
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('Nádraží vršovice', 'Skákal pes přes oves', '', '2014-10-22 21:41:04.777', 50.082100, 14.423580, 'NEW', 1);
INSERT INTO incident(address, title, description, insertedtime, latitude, longitude, state, region_id) VALUES ('I.P.Pavlova bašta', 'Tahle aplikace je strašný brak', '', '2014-10-22 22:41:04.777', 50.082200, 14.436890, 'NEW', 1);
...
INSERT INTO person(username, password, name, surname, role, region_id) VALUES ('spravce@eos.cz', '3PB7skoIkZ/gbONsrtcdPUYNxGBG0Wsds/3HzOLAiiI=', 'Správce', 'Systému', 'SUPER_ADMIN', null);
INSERT INTO person(username, password, name, surname, role, region_id) VALUES ('region@eos.cz', 'xpfSmBv0FlaaFs+83sFUK1OY88x30rkFgZqpnEbs9vY=', 'Region', 'Admin', 'REGION_ADMIN', 1);
INSERT INTO person(username, password, name, surname, role, region_id) VALUES ('officer@eos.cz', '1x8L1iPl4LQOtLQ1UJHQV9XkBkTh5s2hazMhP4rnVB8=', 'Officer', 'Úředník', 'OFFICER', 1);
